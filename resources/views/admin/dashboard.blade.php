...
@section('content')
    ...
    <form action="{{route('home.admin')}}">
        ...
        <div class="col">
            <input class="form-control" type="text" placeholder="Телефон" name="phone"
                   value="{{ old('phone', request()->query('phone')) }}">
        </div>
        <div class="col">
            <input class="form-control" type="text" placeholder="Почта" name="email"
        ...
        <div class=" g-3 mb-3 mt-3">
            ...
            <input type="reset" class="btn btn-primary btn-warning">
        </div>
    </form>
    <table class="table">
        <thead>
